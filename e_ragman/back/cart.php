...
<form class="row g-3 needs-validation" method="POST" novalidate>
  <div class="input-group">
    <input for="amount" type="text" class="form-control" placeholder="Amount" aria-label="Dollar amount (with dot and two decimal places)" id="amount" name="amount">
    ...
    <n>
      <div class="col-12">
        <div class="col-md-6" style="margin-left: -2  px;">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="street_house_no" name="street_house_no"required>
        <div class="invalid-feedback">
      ...
      <div class="col-12">
      <a>  <button class="btn btn-primary" type="submit" name="insert" href="confirm.html" >Submit </button></a>
      </div>
  </form>
