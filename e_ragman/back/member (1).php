...
<div class="formdiv">
	...
	<fieldset class="row mb-3">
					...
					<div class="col-sm-10">
				zzzzzzzzzzz		<div class="form-check">
...
<?php
 ...
 if(isset($_POST['insert']))
 {
    ...
    $scrap = $_POST['scrap'];
 	...
 	$query = "INSERT INTO `customerlist` (`username`,`address`,`contact`,`scrap`) VALUES ('$username','$address','$contact','$scrap')" ;
